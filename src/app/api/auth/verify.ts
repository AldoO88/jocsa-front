...
import { jwtMiddleware } from '@/server/core/middleware/jwt.middleware';
import connectToDatabase from '@/server/core/database/mongodb';
import users from '@/server/modules/auth/models/User.model';
