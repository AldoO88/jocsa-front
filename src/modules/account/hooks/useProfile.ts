...
import { useAuth } from '@/shared/context/auth.context'; // Se importa el contexto de autenticación
import userService from '@/modules/account/services/userService'; // Se importa el servicio de usuario
